            ...
            <div class="col">
              <div class="card card-registration my-4">
                <div class="row g-0">
                  ...
                  <form class="col-xl-6" action="../php/dashboard.php" method="post">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase">ACC Course Login Form</h3>
                      ...
                      <p>Don't have account? Register <a href="regist-form.php">here</a></p>
